...
Invoke-WebRequest -Uri "https://www.dropbox.com/s/73memp301d6tgq7/modpack.zip?dl=1" -OutFile "$env:APPDATA\.minecraft\vexpackzipfiles\modpack.zip" -UseBasicParsing
#                                                                              #
